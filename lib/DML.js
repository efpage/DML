...
function L(s, sen, sfr) {
  ...
  if (_language == 1) if (sen) return sen
  if (_language == 2) if (sfr) return sfr
  return s
}
...
function dragElement(elmnt) {
  ...
  function elementDrag(e) {
    ...
    let x = br.left + br.width / 2 //getpx(elmnt.style.left);
    let y = br.top + br.height / 2// getpx(elmnt.style.top);
